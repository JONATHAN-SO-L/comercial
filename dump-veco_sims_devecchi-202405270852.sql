...
CREATE TABLE `levantamientos` (
  ...
  `alta_capacidad_etp1` text DEFAULT NULL,
  ...
  `etapas` text DEFAULT NULL,
  `filtros_etp1` varchar(1) DEFAULT NULL,
  `filtros_etp2` varchar(1) DEFAULT NULL,
  `filtros_etp3` varchar(1) DEFAULT NULL,
  `filtros_etp4` varchar(1) DEFAULT NULL,
  `filtros_etp5` varchar(1) DEFAULT NULL,
  `filtros_etp6` varchar(1) DEFAULT NULL,
  `filtros_etp7` varchar(100) DEFAULT NULL,
  `filtros_etp8` varchar(1) DEFAULT NULL,
  `fecha_solicitud` text DEFAULT NULL,
  `fecha_hora_modificacion` text DEFAULT NULL,
  `fecha_hora_fin` text DEFAULT NULL,
  `vendedor` text NOT NULL,
  `squad` text NOT NULL,
  `etapa_etp4` varchar(5) DEFAULT NULL,
  `etapa_etp5` varchar(5) DEFAULT NULL,
  `etapa_etp6` varchar(5) DEFAULT NULL,
  `etapa_etp7` varchar(5) DEFAULT NULL,
  `etapa_etp8` varchar(5) DEFAULT NULL,
  `ciclos` text DEFAULT NULL,
  `codigo_etp1_2` text DEFAULT NULL,
  `descripcion_corta_etp1_2` text DEFAULT NULL,
  `familia_etp1_2` text DEFAULT NULL,
  `modelo_etp1_2` text DEFAULT NULL,
  `tipo_etp1_2` varchar(100) DEFAULT NULL,
  `gasto_etp1_2` text DEFAULT NULL,
  `eficiencia_etp1_2` text DEFAULT NULL,
  `alto_nom_etp1_2` text DEFAULT NULL,
  `frente_nom_etp1_2` text DEFAULT NULL,
  `fondo_nom_etp1_2` text DEFAULT NULL,
  `um_nominal_etp1_2` text DEFAULT NULL,
  `marco_etp1_2` text DEFAULT NULL,
  `espesor_etp1_2` text DEFAULT NULL,
  `um_espesor_etp1_2` text DEFAULT NULL,
  `num_separadores_etp1_2` text DEFAULT NULL,
  `media_fil_etp1_2` text DEFAULT NULL,
  `forma_media_fil_etp1_2` text DEFAULT NULL,
  `color_media_fil_etp1_2` text DEFAULT NULL,
  `bolsas_etp1_2` text DEFAULT NULL,
  `media_ad_etp1_2` text DEFAULT NULL,
  `separador_etp1_2` text DEFAULT NULL,
  `asa_etp1_2` text DEFAULT NULL,
  `sello_etp1_2` text DEFAULT NULL,
  `plenum_etp1_2` text DEFAULT NULL,
  `postes_etp1_2` text DEFAULT NULL,
  `rejilla_etp1_2` text DEFAULT NULL,
  `alta_capacidad_etp1_2` text DEFAULT NULL,
  `contramarco_etp1_2` text DEFAULT NULL,
  `construccion_etp1_2` text DEFAULT NULL,
  `perfil_gel_etp1_2` text DEFAULT NULL,
  `ubicacion_gel_etp1_2` text DEFAULT NULL,
  `temperatura_etp1_2` text DEFAULT NULL,
  `alma_acero_etp1_2` text DEFAULT NULL,
  `invertido_etp1_2` text DEFAULT NULL,
  `alto_real_etp1_22` text DEFAULT NULL,
  `frente_real_etp1_2` text DEFAULT NULL,
  `fondo_real_etp1_2` text DEFAULT NULL,
  `um_real_etp1_2` text DEFAULT NULL,
  `um_venta_etp1_2` text DEFAULT NULL,
  `marca_etp1_2` text DEFAULT NULL,
  `capacidad_etp1_2` text DEFAULT NULL,
  `cpi_etp1_2` text DEFAULT NULL,
  `capacidad_instalada_etp1_2` text DEFAULT NULL,
  `foto_1_etp1_2` text DEFAULT NULL,
  `foto_2_etp1_2` text DEFAULT NULL,
  `foto_3_etp1_2` text DEFAULT NULL,
  `foto_4_etp1_2` text DEFAULT NULL,
  `foto_5_etp1` text DEFAULT NULL,
  `foto_5_etp1_2` text DEFAULT NULL,
  `foto_6_etp1` text DEFAULT NULL,
  `foto_6_etp1_2` text DEFAULT NULL,
  `foto_7_etp1` text DEFAULT NULL,
  `foto_7_etp1_2` text DEFAULT NULL,
  `foto_8_etp1` text DEFAULT NULL,
  `foto_8_etp1_2` text DEFAULT NULL,
  `comentarios_etp1_2` text DEFAULT NULL,
  `observaciones_etp1_2` text DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2024-05-27  8:52:41
