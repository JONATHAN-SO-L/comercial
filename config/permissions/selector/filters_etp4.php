...
require '../../conex.php';
// $s_ -> search
$s_tape_fil = $con->prepare("SELECT etapa_etp4, filtros_etp4 FROM levantamientos WHERE uma = :uma");
...
foreach ($f_tape_fil as $item) {
    $f_tape = $item -> etapa_etp4;
    $f_fil = $item -> filtros_etp4;
}
...
<div class="row">
    <div class="col-sm-12">
        <div class="page-header"><br>
            <img class="empresa_pic" src="../../../assets/img/filtro.png" style="margin-right: 15px;"><h1 class="animated lightSpeedIn">ETAPA 4 | Filtros para UMA: <i><u><?php echo $uma; ?></u></i></h1><br>
        </div>
    </div>
</div>
