...
if ($_SESSION['nombre'] && $_SESSION['tipo']) {
	...
	<body><br><br>
		...
		<div class="container col-sm-8 panel panel-body"><br><br>
			...
			<form method="POST" action="../../functions/mod/mod_lev.php?<?php echo $uma;?>" class="border border-danger form-control">
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $codigo) {
						echo '<input type="text" name="codigo_etp1" class="form-control"  placeholder="Ingresa el código del filtro" maxlength="25" value="'.$codigo->codigo_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $descripcion_corta) {
						echo '<input type="text" name="descripcion_corta_etp1" class="form-control"  placeholder="Añade una descripción" maxlength="90" value="'.$descripcion_corta->descripcion_corta_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $familia) {
						echo '<select name="familia_etp1" class="form-control" >
						<option value="'.$familia -> familia_etp1.'">'.$familia -> familia_etp1.' - (Actual)</option>
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $modelo) {
						echo '<select name="modelo_etp1" class="form-control" >
						<option value="'.$modelo -> modelo_etp1.'">'.$modelo -> modelo_etp1.' - (Actual)</option>
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $tipo) {
						echo '<select name="tipo_etp1" class="form-control" >
						<option value="'.$tipo -> tipo_etp1.'">'.$tipo -> tipo_etp1.' - (Actual)</option>
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $eficiencia) {
						echo '<select name="eficiencia_etp1" class="form-control" >
						<option value="'.$eficiencia -> eficiencia_etp1.'">'.$eficiencia -> eficiencia_etp1.' - (Actual)</option>
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $gasto) {
						echo '<input type="text" name="gasto_etp1" class="form-control"  placeholder="Ingresa el gasto" maxlength="20" value="'.$gasto -> gasto_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $alto_nominal) {
						echo '<input type="number" min="0" step="any" name="alto_nom_etp1" class="form-control"  placeholder="Ingresa el alto" maxlength="10" value="'.$alto_nominal -> alto_nom_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $frente_nominal) {
						echo '<input type="number" min="0" step="any" name="frente_nom_etp1" class="form-control"  placeholder="Ingresa el frente" maxlength="10" value="'.$frente_nominal -> frente_nom_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $fondo_nominal) {
						echo '<input type="number" min="0" step="any" name="fondo_nom_etp1" class="form-control"  placeholder="Ingresa el fondo" maxlength="10" value="'.$fondo_nominal -> fondo_nom_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $um_nominal) {
						echo '<select name="um_nominal_etp1" class="form-control" >
						<option value="'.$um_nominal -> um_nominal_etp1.'">'.$um_nominal -> um_nominal_etp1.' - (Actual)</option>
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $marco) {
						echo '<select name="marco_etp1" class="form-control" >
						<option value="'.$marco -> marco_etp1.'">'.$marco -> marco_etp1.' - (Actual)</option>
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $espesor) {
						echo '<input type="number" min="0" name="espesor_etp1" step="any" class="form-control"  placeholder="Agrega el espesor del marco" maxlength="10" value="'.$espesor -> espesor_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $um_espesor) {
						echo '<select name="um_espesor_etp1" class="form-control" >
						<option value="'.$um_espesor -> um_espesor_etp1.'">'.$um_espesor -> um_espesor_etp1.' - (Actual)</option>
						<option value="in">Pulgadas</option>
						<option value="mm">Milímetros</option>
						<option value="cm">Centímetros</option>
						<option value="ft">Pies</option>
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $media_fil) {
						echo '<select name="media_fil_etp1" class="form-control" >
						<option value="'.$media_fil -> media_fil_etp1.'">'.$media_fil -> media_fil_etp1.' - (Actual)</option>
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $forma_media_fil) {
						echo '<select name="forma_media_fil_etp1" class="form-control" >
						<option value="'.$forma_media_fil -> forma_media_fil_etp1.'">'.$forma_media_fil -> forma_media_fil_etp1.' - (Actual)</option>
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $color_media_fil) {
						echo '<select name="color_media_fil_etp1" class="form-control" >
						<option value="'.$color_media_fil -> color_media_fil_etp1.'">'.$color_media_fil -> color_media_fil_etp1.' - (Actual)</option>
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $bolsas) {
						echo '<input type="number" min="0" name="bolsas_etp1" class="form-control"  placeholder="Ingresa el número de bolsas" maxlength="5" value="'.$bolsas -> bolsas_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $media_ad) {
						echo '<select name="media_ad_etp1" class="form-control" >
						<option value="'.$media_ad -> media_ad_etp1.'">'.$media_ad -> media_ad_etp1.' - (Actual)</option>
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $num_separadores) {
						echo '<input type="number" min="0" name="num_separadores_etp1" class="form-control"  placeholder="Ingresa el número de separadores" maxlength="5" value="'.$num_separadores -> num_separadores_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $separador) {
						echo '<select name="separador_etp1" class="form-control" >
						<option value="'.$separador -> separador_etp1.'">'.$separador -> separador_etp1.' - (Actual)</option>
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $asa) {
						echo '<select name="asa_etp1" class="form-control" >
						<option value="'.$asa -> asa_etp1.'">'.$asa -> asa_etp1.' - (Actual)</option>
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $plenum) {
						echo '<select name="plenum_etp1" class="form-control" >
						<option value="'.$plenum -> plenum_etp1.'">'.$plenum -> plenum_etp1.' - (Actual)</option>
						<option value="N/A">No aplica</option>
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $postes) {
						echo '<select name="postes_etp1" class="form-control" >
						<option value="'.$postes -> postes_etp1.'">'.$postes -> postes_etp1.' - (Actual)</option>
						<option value="Plastico">Plástico</option>
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $rejilla) {
						echo '<select name="rejilla_etp1" class="form-control" >
						<option value="'.$rejilla -> rejilla_etp1.'">'.$rejilla -> rejilla_etp1.' - (Actual)</option>
						<option value="No aplica">No aplica</option>
						<option value="Entrada Aire">Entrada Aire</option>
						<option value="Salida Aire">Salida Aire</option>
						<option value="Entrada y Salida de Aire">Entrada y Salida de Aire</option>
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $contramarco) {
						echo '<select name="contramarco_etp1" class="form-control" >
						<option value="'.$contramarco -> contramarco_etp1.'">'.$contramarco -> contramarco_etp1.' - (Actual)</option>
						<option value="N/A">No aplica</option>
						<option value="Entrada Aire">Entrada Aire</option>
						<option value="Salida Aire">Salida Aire</option>
						<option value="Entrada y Salida de Aire">Entrada y Salida de Aire</option>
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $construccion) {
						echo '<select name="construccion_etp1" class="form-control" >
						<option value="'.$construccion -> construccion_etp1.'">'.$construccion -> construccion_etp1.' - (Actual)</option>
						<option value="No aplica">No aplica</option>
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $sello) {
						echo '<select name="sello_etp1" class="form-control" >
						<option value="'.$sello -> sello_etp1.'">'.$sello -> sello_etp1.' - (Actual)</option>
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $perfil_gel) {
						echo '<select name="perfil_gel_etp1" class="form-control" >
						<option value="'.$perfil_gel -> perfil_gel_etp1.'">'.$perfil_gel -> perfil_gel_etp1.' - (Actual):</option>
						<option value="No aplica">No aplica</option>
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $ubicacion_gel) {
						echo '<select name="ubicacion_gel_etp1" class="form-control" >
						<option value="'.$ubicacion_gel -> ubicacion_gel_etp1.'">'.$ubicacion_gel -> ubicacion_gel_etp1.' - (Actual)</option>
						<option value="N/A">No aplica</option>
						<option value="Entrada Aire">Entrada Aire</option>
						<option value="Salida Aire">Salida Aire</option>
						</select><br>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $temperatura) {
						echo '<select name="temperatura_etp1" class="form-control" >
						<option value="'.$temperatura -> temperatura_etp1.'">'.$temperatura -> temperatura_etp1.' - (Actual)</option>
						<option value="No aplica">No aplica</option>
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $alma_acero) {
						echo '<select name="alma_acero_etp1" class="form-control" >
						<option value="'.$alma_acero -> alma_acero_etp1.'">'.$alma_acero -> alma_acero_etp1.' - (Actual)</option>
						<option value="No aplica">No aplica</option>
						<option value="Si">Si</option>
						</select><br>';
					}
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $invertido) {
						echo '<select name="invertido_etp1" class="form-control" >
						<option value="'.$invertido -> invertido_etp1.'">'.$invertido -> invertido_etp1.' - (Actual)</option>
						<option value="No aplica">No aplica</option>
						<option value="Si">Si</option>
						</select><br>';
					}
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $alto_real) {
						echo '<input type="number" min="0" step="any" name="alto_real_etp1" class="form-control"  placeholder="Ingresa el alto" maxlength="10" value="'.$alto_real -> alto_real_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $frente_real) {
						echo '<input type="number" min="0" step="any" name="frente_real_etp1" class="form-control"  placeholder="Ingresa el frente" maxlength="10" value="'.$frente_real -> frente_real_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $fondo_real) {
						echo '<input type="number" min="0" step="any" name="fondo_real_etp1" class="form-control"  placeholder="Ingresa el fondo" maxlength="10" value="'.$fondo_real -> fondo_real_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $um_real) {
						echo '<select name="um_real_etp1" class="form-control" >
						<option value="'.$um_real -> um_real_etp1.'">'.$um_real -> um_real_etp1.' - (Actual)</option>
						<option value="in">Pulgadas</option>
						<option value="mm">Milímetros</option>
						<option value="cm">Centímetros</option>
						<option value="ft">Pies</option>
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $um_venta) {
						echo '<select name="um_venta_etp1" class="form-control" >
						<option value="'.$um_venta -> um_venta_etp1.'">'.$um_venta -> um_venta_etp1.' - (Actual)</option>
						<option value="No aplica">No aplica</option>
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $marca) {
						echo '<input type="text" name="marca_etp1" class="form-control"  placeholder="Ingresa la marca" maxlength="10" value="'.$marca -> marca_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $capacidad) {
						echo '<input type="number" min="0" name="capacidad_etp1" class="form-control"  placeholder="Ingresa la capacidad" maxlength="10" value="'.$capacidad -> capacidad_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $cpi) {
						echo '<input type="number" min="0" name="cpi_etp1" class="form-control"  placeholder="Anota el valor correspondiente" maxlength="10" value="'.$cpi -> cpi_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $capcidad_instalada) {
						echo '<input type="number" min="0" name="capacidad_instalada_etp1" class="form-control"  placeholder="Ingresa la capacidad instalada" maxlength="10" value="'.$capcidad_instalada -> capacidad_instalada_etp1.'">';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $foto_1) {
						echo '<input type="file" name="foto_1_etp1" class="form-control" value="'.$foto_1 -> foto_1_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $foto_2) {
						echo '<input type="file" name="foto_2_etp1" class="form-control" value="'.$foto_2 -> foto_2_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $foto_3) {
						echo '<input type="file" name="foto_3_etp1" class="form-control" value="'.$foto_3 -> foto_3_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $foto_4) {
						echo '<input type="file" name="foto_4_etp1" class="form-control" value="'.$foto_4 -> foto_4_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $comentarios) {
						echo '<input type="text" name="comentarios_etp1" class="form-control" placeholder="Agrega tus comentarios en este apartado" value="'.$comentarios -> comentarios_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $observaciones) {
						echo '<input type="text" name="observaciones_etp1" class="form-control" placeholder="Ingresa las observaciones pertinentes aquí" value="'.$observaciones -> observaciones_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
