			...
			<form method="POST" action="../../functions/mod/mod_lev.php?<?php echo $uma;?>" class="border border-danger form-control">
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $alto_nominal) {
						echo '<input type="number" step="any" name="alto_nom_etp1" class="form-control"  placeholder="Ingresa el alto" maxlength="10" value="'.$alto_nominal -> alto_nom_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $frente_nominal) {
						echo '<input type="number" step="any" name="frente_nom_etp1" class="form-control"  placeholder="Ingresa el frente" maxlength="10" value="'.$frente_nominal -> frente_nom_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $fondo_nominal) {
						echo '<input type="number" step="any" name="fondo_nom_etp1" class="form-control"  placeholder="Ingresa el fondo" maxlength="10" value="'.$fondo_nominal -> fondo_nom_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $espesor) {
						echo '<input type="number" name="espesor_etp1" step="any" class="form-control"  placeholder="Agrega el espesor del marco" maxlength="10" value="'.$espesor -> espesor_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $bolsas) {
						echo '<input type="number" name="bolsas_etp1" class="form-control"  placeholder="Ingresa el número de bolsas" maxlength="5" value="'.$bolsas -> bolsas_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $num_separadores) {
						echo '<input type="number" name="num_separadores_etp1" class="form-control"  placeholder="Ingresa el número de separadores" maxlength="5" value="'.$num_separadores -> num_separadores_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $alto_real) {
						echo '<input type="number" step="any" name="alto_real_etp1" class="form-control"  placeholder="Ingresa el alto" maxlength="10" value="'.$alto_real -> alto_real_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $frente_real) {
						echo '<input type="number" step="any" name="frente_real_etp1" class="form-control"  placeholder="Ingresa el frente" maxlength="10" value="'.$frente_real -> frente_real_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $fondo_real) {
						echo '<input type="number" step="any" name="fondo_real_etp1" class="form-control"  placeholder="Ingresa el fondo" maxlength="10" value="'.$fondo_real -> fondo_real_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $capacidad) {
						echo '<input type="number" name="capacidad_etp1" class="form-control"  placeholder="Ingresa la capacidad" maxlength="10" value="'.$capacidad -> capacidad_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $cpi) {
						echo '<input type="number" name="cpi_etp1" class="form-control"  placeholder="Anota el valor correspondiente" maxlength="10" value="'.$cpi -> cpi_etp1.'"><br>';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
				...
				if ($q_lev1 -> rowCount() > 0) {
					foreach ($levantamientos_uno as $capcidad_instalada) {
						echo '<input type="number" name="capacidad_instalada_etp1" class="form-control"  placeholder="Ingresa la capacidad instalada" maxlength="10" value="'.$capcidad_instalada -> capacidad_instalada_etp1.'">';
					}
				} else {
					echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay empresas a modificar</h3></strong></center></div>';
					echo '<script>console.log("ERROR 100: Fallo al mostrar datos, no hay datos")</script>';
