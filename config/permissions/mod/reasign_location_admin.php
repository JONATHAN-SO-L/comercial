...
if ($_SESSION['nombre'] && $_SESSION['tipo']) {
	...
	<body><br><br>
		<div class="container col-sm-8 panel panel-body"><br><br>
			...
			<form method="POST" action="../../functions/mod/reasign_location_admin.php?<?php echo $ubicacion_id;?>" class="border border-danger form-control"><br>
				
				<select class="form-control" name="new_seller" required>
					<option value=""> - Selecciona el nuevo vendedor a asignar - </option>
					<?php

					$s_seller = $con->prepare("SELECT nombre, usuario FROM usuario_lev WHERE area = 'Ventas' ORDER BY nombre ASC");
