...
if ($_SESSION['nombre'] && $_SESSION['tipo']) {
	...
	<body><br><br>
		<div class="container col-sm-8 panel panel-body"><br><br>
			<img class="empresa_pic" src="../../../assets/img/captura_informacion.png" style="margin-right: 15px;"><h3 style="margin-top: 10px;">Reasignar Empresa: <strong><?php echo $ubicacion; ?></strong></h3><br>
			<div class="card">
