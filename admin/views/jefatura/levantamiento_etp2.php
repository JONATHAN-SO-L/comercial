...
<body><br><br><br><br>
	<div class="container">
		...
		<form class="border border-danger form-control" required method="POST" action="../../../config/permissions/add/add_stage2.php" enctype="multipart/form-data">
			...
			<input type="number" min="0" step="any" name="alto_nom_etp2" class="form-control" required placeholder="Ingresa el alto" maxlength="10"><br>
			<label><strong>Frente Nominal:</strong></label>
			<input type="number" min="0" step="any" name="frente_nom_etp2" class="form-control" required placeholder="Ingresa el frente" maxlength="10"><br>
			<label><strong>Fondo Nominal:</strong></label>
			<input type="number" min="0" step="any" name="fondo_nom_etp2" class="form-control" required placeholder="Ingresa el fondo" maxlength="10"><br>
			...
			<input type="number" min="0" name="espesor_etp2" step="any" class="form-control" required placeholder="Agrega el espesor del marco" maxlength="10"><br>
			...
			<input type="number" min="0" name="bolsas_etp2" class="form-control" required placeholder="Ingresa el número de bolsas" maxlength="5"><br>
			...
			<input type="number" min="0" name="num_separadores_etp2" class="form-control" required placeholder="Ingresa el número de separadores" maxlength="5"><br>
			...
			<input type="number" min="0" step="any" name="alto_real_etp2" class="form-control" required placeholder="Ingresa el alto" maxlength="10"><br>
			<label><strong>Frente Real:</strong></label>
			<input type="number" min="0" step="any" name="frente_real_etp2" class="form-control" required placeholder="Ingresa el frente" maxlength="10"><br>
			<label><strong>Fondo Real:</strong></label>
			<input type="number" min="0" step="any" name="fondo_real_etp2" class="form-control" required placeholder="Ingresa el fondo" maxlength="10"><br>
			...
			<input type="number" min="0" name="capacidad_etp2" class="form-control" required placeholder="Ingresa la capacidad" maxlength="10"><br>
			<label><strong>CPI:</strong></label>
			<input type="number" min="0" name="cpi_etp2" class="form-control" required placeholder="Anota el valor correspondiente" maxlength="10"><br>
			<label><strong>Capacidad Instalada:</strong></label>
			<input type="number" min="0" name="capacidad_instalada_etp2" class="form-control" required placeholder="Ingresa la capacidad instalada" maxlength="10"><br>
