...
<body><br><br><br><br>
	<div class="container">
		...
		<div class="card">
			<div class="card bg-danger text-white"><center><h6><strong>ETAPA 3</strong></h6></center></div>
		</div>
		...
		<form class="border border-danger form-control" required method="POST" action="../../../config/permissions/add/add_stage3.php" enctype="multipart/form-data">
			...
			<input type="text" name="descripcion_corta_etp3" class="form-control" required placeholder="Añade una descripción" maxlength="90"><br>
			<label><strong>Familia:</strong></label>
			<select name="familia_etp3" class="form-control" required>
				<option></option>
			...
			<select name="modelo_etp3" class="form-control" required>
				<option></option>
			...
			<select name="tipo_etp3" class="form-control" required>
				<option></option>
			...
			<select name="eficiencia_etp3" class="form-control" required>
				<option></option>
			...
			<select name="marco_etp3" class="form-control" required>
				<option></option>
			...
			<select name="media_fil_etp3" class="form-control" required>
				<option></option>
			...
			<select name="forma_media_fil_etp3" class="form-control" required>
				<option></option>
			...
			<select name="color_media_fil_etp3" class="form-control" required>
				<option></option>
			...
			<select name="asa_etp3" class="form-control" required>
				<option></option>
				<option value="1">1</option>
				<option value="2">2</option>
			</select><br>
			<label><strong>Plenum:</strong></label>
			<select name="plenum_etp3" class="form-control" required>
				<option></option>
				<option value="N/A">No aplica</option>
			...
			<select name="postes_etp3" class="form-control" required>
				<option></option>
				<option value="Plastico">Plástico</option>
			...
			<select name="rejilla_etp3" class="form-control" required>
				<option></option>
				<option value="No aplica">No aplica</option>
				<option value="Entrada Aire">Entrada Aire</option>
				<option value="Salida Aire">Salida Aire</option>
			...
			<select name="contramarco_etp3" class="form-control" required>
				<option></option>
				<option value="N/A">No aplica</option>
				<option value="Entrada Aire">Entrada Aire</option>
				<option value="Salida Aire">Salida Aire</option>
			...
			<select name="construccion_etp3" class="form-control" required>
				<option></option>
				<option value="No aplica">No aplica</option>
				<option value="W">W</option>
			</select><br><label><strong>Sello:</strong></label>
			<select name="sello_etp3" class="form-control" required>
				<option></option>
				<option value="Neopreno">Neopreno</option>
				<option value="Gel">Gel</option>
			</select><br>
			<label><strong>Perfil del Gel:</strong></label>
			<select name="perfil_gel_etp3" class="form-control" required>
				<option></option>
				<option value="No aplica">No aplica</option>
			...
			<select name="ubicacion_gel_etp3" class="form-control" required>
				<option></option>
				<option value="N/A">No aplica</option>
				<option value="Entrada Aire">Entrada Aire</option>
				<option value="Salida Aire">Salida Aire</option>
			...
			<select name="temperatura_etp3" class="form-control" required>
				<option></option>
				<option value="No aplica">No aplica</option>
			...
			<select name="alma_acero_etp3" class="form-control" required>
				<option></option>
				<option value="No aplica">No aplica</option>
				<option value="Si">Si</option>
			</select><br>
			<label><strong>Invertido:</strong></label>
			<select name="invertido_etp3" class="form-control" required>
				<option></option>
				<option value="No aplica">No aplica</option>
				<option value="Si">Si</option>
			</select><br>
			...
			<select name="um_venta_etp3" class="form-control" required>
				<option></option>
				<option value="No aplica">No aplica</option>
			...
			<input type="file" name="foto_1_etp3" class="form-control"><br>
			<label><strong>Foto 2 <i>(Opcional)</i>:</strong></label>
			<input type="file" name="foto_2_etp3" class="form-control"><br>
			<label><strong>Foto 3 <i>(Opcional)</i>:</strong></label>
			<input type="file" name="foto_3_etp3" class="form-control"><br>
			<label><strong>Foto 4 <i>(Opcional)</i>:</strong></label>
			<input type="file" name="foto_4_etp3" class="form-control"><br><br>
			<label><strong>Comentarios <i>(Opcional)</i>:</strong></label>
			<textarea name="comentarios_etp3" class="form-control" placeholder="Agrega tus comentarios en este apartado"></textarea><br>
			<label><strong>Observaciones <i>(Opcional)</i>:</strong></label>
			<textarea name="observaciones_etp3" class="form-control" placeholder="Ingresa las observaciones pertinentes aquí"></textarea><br>
			<center><button type="submit" class="btn btn-success" name="guardar_etp3"><strong>Guardar</strong></button></center><br>
		</form><br>
	</div>
