...
if ($_SESSION['nombre'] && $_SESSION['tipo']) { 
	...
	<body><br><br><br><br>
		<a href="cuadrilla.php" class="btn btn-primary nuevo_lev"><img class="agregar" src="../../../assets/img/agregar.png"> <strong>Nuevo Integrante</strong></a>

		<div class="container" >
			<div class="row">
				<div class="col-sm-12">
					<div class="page-header2"><br>
						<img class="empresa_pic" src="../../../assets/img/cuadrilla.png" style="margin-right: 15px;"><h1 class="animated lightSpeedIn">Integrantes de mi cuadrilla</h1>
					</div>
				</div>
			</div>
		</div><br>
	...
	<!------------------------------
		...
		$data = $con->prepare("SELECT * FROM usuario_lev WHERE squad = '$squad' ORDER BY nombre ASC");
		...
		if ($data -> rowCount() > 0) {
			...
			echo '<br><div class="alert alert-danger container"><center><strong><h3>No hay integrantes registrados</h3></strong></center></div>';
