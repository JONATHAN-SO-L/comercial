...
if ($_SESSION['nombre'] && $_SESSION['tipo']) { switch ($_SESSION['tipo']) {
	case 'A':
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="page-header2"><br>
					<img class="empresa_pic" src="../../../assets/img/ubicacion.png" style="margin-right: 15px;"><h1 class="animated lightSpeedIn">Mis ubicaciones</h1>
				</div>
			</div>
		</div>
	</div><br>
