...
<body><br>
	<div class="container">
		...
		<div class="card">
			<div class="card bg-danger text-white"><center><h6><strong>ETAPA 5</strong></h6></center></div>
		</div>

		<form class="border border-danger form-control"  method="POST" action="../../../config/permissions/add/add_stage5.php" enctype="multipart/form-data">
			<!-------------
			ETAPA 5
			-------------->
			<label><strong>Código:</strong></label>
			<input type="text" name="codigo_etp5" class="form-control"  placeholder="Ingresa el código del filtro" maxlength="25"><br>
			<label><strong>Descripción corta:</strong></label>
			<input type="text" name="descripcion_corta_etp5" class="form-control"  placeholder="Añade una descripción" maxlength="90"><br>
			<label><strong>Familia:</strong></label>
			<select name="familia_etp5" class="form-control" >
				<option></option>
			...
			<select name="modelo_etp5" class="form-control" >
				<option></option>
			...
			<select name="tipo_etp5" class="form-control" >
				<option></option>
			...
			<select name="eficiencia_etp5" class="form-control" >
				<option></option>
			...
			<input type="text" name="gasto_etp5" class="form-control"  placeholder="Ingresa el gasto" maxlength="20"><br>
			<label><strong>Alto Nominal:</strong></label>
			<input type="number" min="0" step="any" name="alto_nom_etp5" class="form-control"  placeholder="Ingresa el alto" maxlength="10"><br>
			<label><strong>Frente Nominal:</strong></label>
			<input type="number" min="0" step="any" name="frente_nom_etp5" class="form-control"  placeholder="Ingresa el frente" maxlength="10"><br>
			<label><strong>Fondo Nominal:</strong></label>
			<input type="number" min="0" step="any" name="fondo_nom_etp5" class="form-control"  placeholder="Ingresa el fondo" maxlength="10"><br>
			<label><strong>Unidad de Medida Nominal:</strong></label>
			<select name="um_nominal_etp5" class="form-control" >
				<option></option>
			...
			<select name="marco_etp5" class="form-control" >
				<option></option>
			...
			<input type="number" min="0" name="espesor_etp5" step="any" class="form-control"  placeholder="Agrega el espesor del marco" maxlength="10"><br>
			<label><strong>Unidad de Medida Espesor:</strong></label>
			<select name="um_espesor_etp5" class="form-control" >
				<option></option>
				<option value="in">Pulgadas</option>
				<option value="mm">Milímetros</option>
				<option value="cm">Centímetros</option>
			...
			<select name="media_fil_etp5" class="form-control" >
				<option></option>
			...
			<select name="forma_media_fil_etp5" class="form-control" >
				<option></option>
			...
			<select name="color_media_fil_etp5" class="form-control" >
				<option></option>
			...
			<input type="number" min="0" name="bolsas_etp5" class="form-control"  placeholder="Ingresa el número de bolsas" maxlength="5"><br>
			<label><strong>Media adherida al marco:</strong></label>
			<select name="media_ad_etp5" class="form-control" >
				<option></option>
				<option value="No aplica">No aplica</option>
				<option value="Si">Si</option>
			</select><br>
			<label><strong>Número de Separadores:</strong></label>
			<input type="number" min="0" name="num_separadores_etp5" class="form-control"  placeholder="Ingresa el número de separadores" maxlength="5"><br>
			<label><strong>Separador:</strong></label>
			<select name="separador_etp5" class="form-control" >
				<option></option>
			...
			<select name="asa_etp5" class="form-control" >
				<option></option>
				<option value="1">1</option>
				<option value="2">2</option>
			</select><br>
			<label><strong>Plenum:</strong></label>
			<select name="plenum_etp5" class="form-control" >
				<option></option>
				<option value="N/A">No aplica</option>
			...
			<select name="postes_etp5" class="form-control" >
				<option></option>
				<option value="Plastico">Plástico</option>
			...
			<select name="rejilla_etp5" class="form-control" >
				<option></option>
				<option value="No aplica">No aplica</option>
				<option value="Entrada Aire">Entrada Aire</option>
				<option value="Salida Aire">Salida Aire</option>
			...
			<select name="contramarco_etp5" class="form-control" >
				<option></option>
				<option value="N/A">No aplica</option>
				<option value="Entrada Aire">Entrada Aire</option>
				<option value="Salida Aire">Salida Aire</option>
			...
			<select name="construccion_etp5" class="form-control" >
				<option></option>
				<option value="No aplica">No aplica</option>
				<option value="W">W</option>
			</select><br>
			<label><strong>Sello:</strong></label>
			<select name="sello_etp5" class="form-control" >
				<option></option>
				<option value="Neopreno">Neopreno</option>
				<option value="Gel">Gel</option>
			</select><br>
			<label><strong>Perfil del Gel:</strong></label>
			<select name="perfil_gel_etp5" class="form-control" >
				<option></option>
				<option value="No aplica">No aplica</option>
			...
			<select name="ubicacion_gel_etp5" class="form-control" >
				<option></option>
				<option value="N/A">No aplica</option>
				<option value="Entrada Aire">Entrada Aire</option>
				<option value="Salida Aire">Salida Aire</option>
			...
			<select name="temperatura_etp5" class="form-control" >
				<option></option>
				<option value="No aplica">No aplica</option>
			...
			<select name="alma_acero_etp5" class="form-control" >
				<option></option>
				<option value="No aplica">No aplica</option>
				<option value="Si">Si</option>
			</select><br>
			<label><strong>Invertido:</strong></label>
			<select name="invertido_etp5" class="form-control" >
				<option></option>
				<option value="No aplica">No aplica</option>
				<option value="Si">Si</option>
			</select><br>
			<label><strong>Alto Real:</strong></label>
			<input type="number" min="0" step="any" name="alto_real_etp5" class="form-control"  placeholder="Ingresa el alto" maxlength="10"><br>
			<label><strong>Frente Real:</strong></label>
			<input type="number" min="0" step="any" name="frente_real_etp5" class="form-control"  placeholder="Ingresa el frente" maxlength="10"><br>
			<label><strong>Fondo Real:</strong></label>
			<input type="number" min="0" step="any" name="fondo_real_etp5" class="form-control"  placeholder="Ingresa el fondo" maxlength="10"><br>
			<label><strong>Unidad de Medida Real:</strong></label>
			<select name="um_real_etp5" class="form-control" >
				<option></option>
				<option value="in">Pulgadas</option>
				<option value="mm">Milímetros</option>
				<option value="cm">Centímetros</option>
			...
			<select name="um_venta_etp5" class="form-control" >
				<option></option>
				<option value="No aplica">No aplica</option>
			...
			<input type="text" name="marca_etp5" class="form-control"  placeholder="Ingresa la marca" maxlength="10"><br>
			<label><strong>Capacidad:</strong></label>
			<input type="number" min="0" name="capacidad_etp5" class="form-control"  placeholder="Ingresa la capacidad" maxlength="10"><br>
			<label><strong>CPI:</strong></label>
			<input type="number" min="0" name="cpi_etp5" class="form-control"  placeholder="Anota el valor correspondiente" maxlength="10"><br>
			<label><strong>Capacidad Instalada:</strong></label>
			<input type="number" min="0" name="capacidad_instalada_etp5" class="form-control"  placeholder="Ingresa la capacidad instalada" maxlength="10"><br>
			...
			<input type="file" name="foto_1_etp5" class="form-control"><br>
			<label><strong>Foto 2 <i>(Opcional)</i>:</strong></label>
			<input type="file" name="foto_2_etp5" class="form-control"><br>
			<label><strong>Foto 3 <i>(Opcional)</i>:</strong></label>
			<input type="file" name="foto_3_etp5" class="form-control"><br>
			<label><strong>Foto 4 <i>(Opcional)</i>:</strong></label>
			<input type="file" name="foto_4_etp5" class="form-control"><br><br>
			<label><strong>Comentarios <i>(Opcional)</i>:</strong></label>
			<textarea name="comentarios_etp5" class="form-control" placeholder="Agrega tus comentarios en este apartado"></textarea><br>
			<label><strong>Observaciones <i>(Opcional)</i>:</strong></label>
			<textarea name="observaciones_etp5" class="form-control" placeholder="Ingresa las observaciones pertinentes aquí"></textarea><br>
			<center><button type="submit" class="btn btn-success" name="guardar_etp5"><strong>Guardar</strong></button></center><br>
		</form><br>
	</div>
