...
<body><br>
	<div class="container">
		...
		<form class="border border-danger form-control" required method="POST" action="../../../config/permissions/add/add_stage1.php" enctype="multipart/form-data">
			...
			<input type="number" step="any" name="alto_nom_etp1" class="form-control" required placeholder="Ingresa el alto" maxlength="10"><br>
			<label><strong>Frente Nominal:</strong></label>
			<input type="number" step="any" name="frente_nom_etp1" class="form-control" required placeholder="Ingresa el frente" maxlength="10"><br>
			<label><strong>Fondo Nominal:</strong></label>
			<input type="number" step="any" name="fondo_nom_etp1" class="form-control" required placeholder="Ingresa el fondo" maxlength="10"><br>
			...
			<input type="number" name="espesor_etp1" step="any" class="form-control" required placeholder="Agrega el espesor del marco" maxlength="10"><br>
			...
			<input type="number" name="bolsas_etp1" class="form-control" required placeholder="Ingresa el número de bolsas" maxlength="5"><br>
			...
			<input type="number" name="num_separadores_etp1" class="form-control" required placeholder="Ingresa el número de separadores" maxlength="5"><br>
			...
			<input type="number" step="any" name="alto_real_etp1" class="form-control" required placeholder="Ingresa el alto" maxlength="10"><br>
			<label><strong>Frente Real:</strong></label>
			<input type="number" step="any" name="frente_real_etp1" class="form-control" required placeholder="Ingresa el frente" maxlength="10"><br>
			<label><strong>Fondo Real:</strong></label>
			<input type="number" step="any" name="fondo_real_etp1" class="form-control" required placeholder="Ingresa el fondo" maxlength="10"><br>
			...
			<input type="number" name="capacidad_etp1" class="form-control" required placeholder="Ingresa la capacidad" maxlength="10"><br>
			<label><strong>CPI:</strong></label>
			<input type="number" name="cpi_etp1" class="form-control" required placeholder="Anota el valor correspondiente" maxlength="10"><br>
			<label><strong>Capacidad Instalada:</strong></label>
			<input type="number" name="capacidad_instalada_etp1" class="form-control" required placeholder="Ingresa la capacidad instalada" maxlength="10"><br>
